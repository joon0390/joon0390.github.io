...
또한 이 작업은 모델 정확도만 보는 문제가 아니라, 복잡한 산악 지형과 사람의 이동 특성을 어떻게 상태와 보상으로 번역하느냐가 훨씬 중요하다는 점을 분명하게 보여줬습니다. 익숙하지 않았던 강화학습을 빠르게 흡수해 구현까지 밀어붙이는 과정 자체가 가장 큰 학습이었고, 덕분에 낯선 방법론도 문제 구조만 명확하면 짧은 시간 안에 실전 수준으로 끌어올릴 수 있다는 자신감을 얻었습니다.
