...
복잡한 학습 없이, 단순한 구조로도 충분히 강력할 수 있다는 사실을 ROCKET은 증명했습니다.

또한, 이 논문은 이후 등장하게 될 [**MiniROCKET**](https://arxiv.org/abs/2012.08791)이나 [**MultiROCKET**](https://arxiv.org/abs/2102.00457)과 같은 후속 연구의 기초를 마련하며, 시계열 분류 분야에서 매우 중요한 전환점을 제공했습니다.
