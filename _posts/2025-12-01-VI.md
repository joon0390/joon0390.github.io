---
layout: single
title: "Variational Inference : KL 기반 근사 베이지안 추론"
date: 2025-11-21
...
> VI는 “**ELBO 최대화 문제**”를 푸는 것과 완전히 같다.
...
이 글에서는 가장 기본이 되는 **mean-field VI** 를 중심으로 설명합니다.
...
| VI | 최적화를 통해 근사 posterior 학습 | 빠름, 대규모 데이터/딥러닝과 궁합 좋음 | mode-seeking, uncertainty 과소추정 가능 |
